    ...
    return {
        ...
        link: function($scope, elem, attrs) {
            ...
            $scope.processResults = function (responseData, str) {
                if (responseData && responseData.length > 0) {
                    ...
                    angular.forEach(responseData, function (item) {
                        ...
                        angular.forEach(titleFields, function (field) {
                            titleCode.push(item[field]);
                        });
                        ...
                        var image = "";
                        if ($scope.imageField) {
                            image = imageUri + item[$scope.imageField];
                        }
            ...
            $scope.selectResult = function(result) {
                ...
                //    $scope.customFunction({ selectedItem : result });
                //    console.log('calling Function');
                //} else {
                //    $scope.customFunction = result;
                //    console.log('calling Object');
                //}
                $scope.selectedObject({ selectedItem: result });
                $scope.showDropdown = false;
                $scope.results = [];
                //$scope.$apply();
            }
